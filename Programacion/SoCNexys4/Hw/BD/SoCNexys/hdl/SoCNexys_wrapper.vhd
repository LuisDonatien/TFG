...
--Command     : generate_target SoCNexys_wrapper.bd
--Design      : SoCNexys_wrapper
...
end SoCNexys_wrapper;

architecture STRUCTURE of SoCNexys_wrapper is
  component SoCNexys is
  port (
    sys_clock : in STD_LOGIC;
    usb_uart_rxd : in STD_LOGIC;
    usb_uart_txd : out STD_LOGIC;
  ...
  end component SoCNexys;
begin
SoCNexys_i: component SoCNexys
     port map (
      A => A,
      A_out => A_out,
      B => B,
