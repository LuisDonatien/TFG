...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {Duty_Led[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Duty_Led[0]}]
set_property PACKAGE_PIN E19 [get_ports {Duty_Led[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Duty_Led[1]}]
set_property PACKAGE_PIN U19 [get_ports {Duty_Led[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Duty_Led[2]}]
set_property PACKAGE_PIN V19 [get_ports {Duty_Led[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Duty_Led[3]}]
set_property PACKAGE_PIN W18 [get_ports {Duty_Led[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Duty_Led[4]}]
set_property PACKAGE_PIN U15 [get_ports {Duty_Led[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Duty_Led[5]}]
set_property PACKAGE_PIN U14 [get_ports {Duty_Led[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Duty_Led[6]}]
set_property PACKAGE_PIN V14 [get_ports {Duty_Led[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Duty_Led[7]}]
set_property PACKAGE_PIN V13 [get_ports {Duty_Led[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Duty_Led[8]}]
set_property PACKAGE_PIN V3 [get_ports {Duty_Led[9]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Duty_Led[9]}]
set_property PACKAGE_PIN W3 [get_ports {A_out}]
set_property IOSTANDARD LVCMOS33 [get_ports {A_out}]
set_property PACKAGE_PIN U3 [get_ports {B_out}]
set_property IOSTANDARD LVCMOS33 [get_ports {B_out}]
set_property PACKAGE_PIN P3 [get_ports {C_out}]
set_property IOSTANDARD LVCMOS33 [get_ports {C_out}]
set_property PACKAGE_PIN N3 [get_ports {PWM_HIGH}]
set_property IOSTANDARD LVCMOS33 [get_ports {PWM_HIGH}]
set_property PACKAGE_PIN P1 [get_ports {PWM_LOW}]
set_property IOSTANDARD LVCMOS33 [get_ports {PWM_LOW}]
...
set_property PACKAGE_PIN T18 [get_ports CONFG]
set_property IOSTANDARD LVCMOS33 [get_ports CONFG]
...
##Pmod Header JA
##Sch name = JA1
#set_property PACKAGE_PIN J1 [get_ports {Duty_Led[10]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {Duty_Led[10]}]
##Sch name = JA2
#set_property PACKAGE_PIN L2 [get_ports {Duty_Led[11]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {Duty_Led[11]}]
##Sch name = JA3
#set_property PACKAGE_PIN J2 [get_ports {PWM_LOW}]
#set_property IOSTANDARD LVCMOS33 [get_ports {PWM_LOW}]
##Sch name = JA4
...
set_property IOSTANDARD LVCMOS33 [get_ports {PWM_AH}]
##Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {PWM_AL}]
set_property IOSTANDARD LVCMOS33 [get_ports {PWM_AL}]
##Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {PWM_BH}]
set_property IOSTANDARD LVCMOS33 [get_ports {PWM_BH}]
##Sch name = JB4
...
##Pmod Header JC
##Sch name = JC1
#set_property PACKAGE_PIN K17 [get_ports {A_PMO}]
#set_property IOSTANDARD LVCMOS33 [get_ports {A_PMO}]
##Sch name = JC2
