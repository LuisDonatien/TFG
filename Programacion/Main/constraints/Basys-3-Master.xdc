## This file is a general .xdc for the Basys3 rev B board 12345
## To use it in a project:
## - uncomment the lines corresponding to used pins Cambios finales
...
## LEDs
#set_property PACKAGE_PIN U16 [get_ports {PWM_AH}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {PWM_AH}]
#set_property PACKAGE_PIN E19 [get_ports {PWM_AL}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {PWM_AL}]
#set_property PACKAGE_PIN U19 [get_ports {PWM_BH}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {PWM_BH}]
#set_property PACKAGE_PIN V19 [get_ports {PWM_BL}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {PWM_BL}]
#set_property PACKAGE_PIN W18 [get_ports {PWM_CH}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {PWM_CH}]
#set_property PACKAGE_PIN U15 [get_ports {PWM_CL}]
